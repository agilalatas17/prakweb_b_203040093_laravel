        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 mb-3" >
                    <div class="card">
                        <div class="position-absolute m-2"><a href="/posts?category={{$post->slug}}" class="badge rounded-pill bg-warning text-dark text-decoration-none">{{$post->category->name}}</a></div>
